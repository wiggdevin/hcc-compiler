...
- Compiled at: 2026-05-27T10:16:28.723039+00:00
...
- **RP-NUT-hydration-electrolyte-training** (pattern): Implement structured pre-, intra-, and post-training hydration with sodium (500-1000 mg/L), potassium (150-250 mg/L), and magnesium (5-10 mg/L) electrolyte replacement scaled to sweat rate and session duration to maintain euhydration and support neuromuscular performance. — matched: *renal disease or on fluid-restricted protocol*
- **RP-NUT-hypertrophy-surplus-lean-mass** (pattern): Sustain a structured caloric surplus of 10-20% above estimated maintenance (approximately 200-400 kcal/day) with protein at 1.6-2.2 g/kg/day alongside progressive resistance training to maximize lean mass accretion while minimizing concurrent fat gain. — matched: *CKD (protein restriction required)*
- **RP-NUT-post-workout-recovery-nutrition** (pattern): Consume 20-40 g of high-quality protein combined with 0.5-1.2 g/kg carbohydrate within 2 hours post-resistance or high-intensity training to support muscle protein synthesis and glycogen resynthesis; the acute anabolic window is real but narrow primarily for those training in a fasted state or with long gaps since the prior meal. — matched: *CKD patients requiring protein restriction.*
...
**For this client (M, 45y, trained):** Resistance-trained adults (1-3 years, 18-49 y): 10-15% caloric surplus; protein 1.8-2.2 g/kg/day; carbohydrate intake does not significantly enhance hypertrophy beyond adequate protein under isonitrogenous conditions; prioritize carbohydrate for training performance rather than anabolic effect.
...
> ⚠ ⚠ CKD (protein restriction required) (matches intake)

### Pattern: RP-NUT-meal-timing-protein-distribution (sim=0.78)
...
**For this client (M, 45y, trained):** Trained females (18-49 y): same per-meal dose structure as resistance-trained adults; body weight-adjusted targets land at 25-35 g/meal for most women; no evidence of sex-specific meal frequency interaction on MPS rate.
<details><summary>All populations covered by this pattern</summary>
...
### Pattern: RP-TRA-maximal-strength-low-rep-trained (sim=0.80)
...
- **EA-TRA-7564** (sim 0.69, pop-match 1.00): Resistance exercise interventions lasting up to 6 months do not result in meaningful changes in muscle fiber number, as meta-analysis results indicated no significant alteration in estimated muscle fibers. ([10.23736/S0022-4707.25.17206-X])
...
### Pattern: RP-SUP-creatine-resistance-body-composition (sim=0.71)
...
### Pattern: RP-REC-exercise-sleep-quality (sim=0.64)
...
- **EA-REC-1657** (sim 0.65, pop-match 1.00): Sleep and circadian interventions in athletes have a more substantial impact on positive affect compared to negative affect. ([10.1007/s40279-025-02387-z])
...
- **EA-BEH-6255** (sim 0.56, pop-match 1.00): Goal-setting guidelines for return-to-work rehabilitation in Australia are inconsistent and primarily based on SMART goal principles. ([10.1071/PY25160])
