...
- Compiled at: 2026-05-26T13:35:10.476609+00:00
...
### Pattern: RP-NUT-caloric-restriction-rt-protein-body-comp (sim=0.81)
...
- **EA-TRA-0496** (sim 0.76, pop-match 1.00): Combining moderate- and low-intensity resistance or aerobic exercise with caloric restriction optimizes fat loss while preserving lean body mass, representing a superior body composition strategy compared to caloric restriction alone. ([10.3389/fnut.2025.1579024])
- **EA-TRA-1931** (sim 0.71, pop-match 1.00): Resistance training under hypoxic conditions (RTH) results in trivial benefits for muscle strength gains compared to normoxic conditions (RTN), with specific programming variables like non-full-body routines and higher weekly volumes potentially enhancing this effect. ([10.1080/02640414.2024.2425536])
...
- **EA-TRA-4688** (sim 0.69, pop-match 1.00): High-intensity interval training appears to improve aerobic capacity in adults with congenital heart disease with no serious adverse events. ([10.1016/j.hlc.2024.09.008])
...
- **EA-REC-8071** (sim 0.63, pop-match 1.00): In offshore sailing, optimal sleep management strategies vary by crew size and race duration: for short regattas, 'banking sleep' beforehand is beneficial, while for long races, 4.5-5.5 h of daily sleep, in 30-min to 1-h episodes, is optimal. ([10.1007/s40279-025-02389-x])
...
- **EA-BEH-6255** (sim 0.58, pop-match 1.00): Goal-setting guidelines for return-to-work rehabilitation in Australia are inconsistent and primarily based on SMART goal principles. ([10.1071/PY25160])
