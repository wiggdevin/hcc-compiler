...
- Compiled at: 2026-05-23T03:36:44.193497+00:00
...
- Intermittent energy restriction (IER) diets combined result in comparable reductions in body weight and fat mass to continuous energy restriction (CER), but lead to slightly greater reductions in fat-free mass and waist circumference. ([10.1016/j.advnut.2023.10.003])
...
- **EA-NUT-6511** (sim 0.79, pop-match 0.80): Meeting a protein threshold of approximately 25-30 g per meal represents a promising dietary strategy to help maintain muscle mass and function in older adults. ([10.3945/ajcn.114.084061])
- **EA-NUT-3504** (sim 0.71, pop-match 0.80): Combined lifestyle interventions including nutrition, exercise, and behavior change improve physical function and may reduce body and fat mass without negatively affecting fat-free mass or bone mineral density in older adults with obesity. ([10.1111/obr.70123])
- **EA-NUT-4538** (sim 0.69, pop-match 0.80): Total daily leucine intake is positively associated with quadriceps muscle cross-sectional area and maximum dynamic muscle strength in healthy older adults. ([10.3390/nu13103536])

## Training

### Pattern: RP-TRA-resistance-volume-hypertrophy-dose-response (sim=0.55)
...
- Higher resistance training volume yields better outcomes for pain intensity and disability compared to lower volume in individuals with patellofemoral pain. ([10.2519/jospt.2025.13062])
...
- **EA-CON-9301** (sim 0.54, pop-match 0.88): Contemporary Olympic Cross-Country mountain biking requires exceptional aerobic capacity but places a greater importance on high-intensity, short-duration efforts and anaerobic contribution compared to the former version of the discipline. ([10.1186/s40798-026-00976-4])
...
- **EA-SUP-3021** (sim 0.76, pop-match 0.76): Creatine supplementation combined with resistance training significantly increases fat-free mass and body mass, with trained individuals exhibiting greater gains in fat-free mass compared to untrained individuals. ([10.1080/15502783.2025.2586523])
...
- **EA-REC-7668** (sim 0.54, pop-match 1.00): Game-based telerehabilitation for stroke, Parkinson's disease, and multiple sclerosis offers opportunities for effectiveness through engaging and affordable technologies, though it faces challenges regarding motivation, usability, and technical barriers. ([10.1080/17483107.2025.2450010])
